  ...
  <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105">
    ...
    <div class="px-4 py-3 bg-gray-100 flex justify-between items-center">
      <button
        ...
        class="text-accent hover:text-primary focus:outline-none"
      ...
      <RouterLink
        ...
        class="px-4 py-2 bg-primary text-white rounded-md hover:bg-secondary transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
      >
        Ver detalles
      </RouterLink>
    </div>
...
const toggleFavorite = () => {
  ...
  // Implementar lógica para guardar/eliminar de favoritos
